...
# -----------------------------------------------------------------------------
def main():
  """This script reads a CSV with recordIDs in the first columns and their ISBN10 identifier in the second column. The ISBN10 identifiers will be formatted correctly and the output is a similar CSV."""
